...
public class SpringBatchRetryIntegrationTest {
    ...
    public void whenEndpointFailsTwicePasses3rdTime_thenSuccess() throws Exception {
        File actualResult = new File(TEST_OUTPUT);
        File expectedResult = new File(EXPECTED_OUTPUT);
        ...
        org.assertj.core.api.Assertions.assertThat(actualResult).hasSameTextualContentAs(expectedResult);
    }
